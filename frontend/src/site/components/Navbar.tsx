    ...
    <nav style={{
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '12px', flexShrink: 0 }}>
        ...
        <div ref={notif.ref} style={{ position: 'relative' }}>
          ...
          <DropdownPanel isOpen={notif.open} right={0} minWidth="280px">
            <div style={{ padding: '16px 20px', textAlign: 'center' }}>
              <span className="font-cinzel" style={{ fontSize: '12px', color: 'var(--text-muted)', letterSpacing: '1px' }}>No notifications yet</span>
            </div>
          </DropdownPanel>
        </div>
        ...
        <div onClick={() => onNavigate('profile')} style={{
          ...
          <img src={avatarUrl || `https://api.dicebear.com/9.x/pixel-art/svg?seed=${username}`} alt=""
            style={{ width: 28, height: 28, borderRadius: '50%', border: '2px solid var(--border-gold)' }} />
          <span className="font-cinzel" style={{ fontSize: '12px', color: 'var(--text-secondary)', letterSpacing: '0.5px' }}>{username}</span>
        </div>
